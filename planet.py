...
class Planet(pygame.sprite.Sprite):
    ...
    def update(self):
        self.rect.centerx += self.x_speed  # gives center of the spaceship on the horizontal axis
        self.rect.centery += self.y_speed

        # will make sure that a planet that leaves the screen will be destroyed so that there aren't too many sprites
        # on screen
